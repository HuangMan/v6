...
CREATE TABLE `v5_category` (
  ...
  `pid` smallint(6) DEFAULT '0' COMMENT '父级栏目id',
  `keywords` varchar(80) DEFAULT NULL COMMENT '关键字',
...
INSERT INTO `v5_category` VALUES ('12', '后盾网', '0', 'IT', '学习快人一步');
INSERT INTO `v5_category` VALUES ('16', '2222222222', '12', '222222222222222', '2222222222222');
